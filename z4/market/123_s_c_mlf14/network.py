...
class Model2(nn.Module):
    def __init__(self):
        ...
        self.backbone3 = resnet.layer2
        self.backbone4 = resnet.layer3
        ...
        self.mlf1_2 = MultiLayerFusionBlock(64, 256)
        self.mlf2_3 = MultiLayerFusionBlock(256, 512)
        self.mlf3_4 = MultiLayerFusionBlock(512, 1024)
        self.mlf4_part1 = MultiLayerFusionBlock(1024, 2048)
        self.mlf4_part2 = MultiLayerFusionBlock(1024, 2048)
        self.mlf4_part3 = MultiLayerFusionBlock(1024, 2048)
    ...
    def forward(self, x):
        ...
        # global feature
        xg = self.part1(m3_4)
        m4_part1 = self.mlf4_part1(m3_4, xg)

        pg = self.avgpool_g(m4_part1)
        ...
        xp2 = self.part2(m3_4)
        m4_part2 = self.mlf4_part2(m3_4, xp2)

        #==================== block STN_2 ====================
        region_2 = []
        xr2 = self.localization_2(m4_part2)
        ...
        for region in range(2):
            ...
            p2_i = self.stn(m4_part2, theta2_i, 2)
            region_2.append(p2_i)


        xp3 = self.part3(m3_4)
        m4_part3 = self.mlf4_part3(m3_4, xp3)

        #==================== block STN_3 ====================
        region_3 = []
        xr3 = self.localization_3(m4_part3)
        ...
        for region in range(3):
            ...
            p3_i = self.stn(m4_part3, theta3_i, 3)
