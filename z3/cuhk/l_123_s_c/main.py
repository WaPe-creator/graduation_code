...
class Main():
    ...
    def vis_stn(self, num):
        ...
        if num == 2:
            ...
            cv2.rectangle(img, (x2, y2), (x2+w*theta2[0,0]-1, y2+h*theta2[1,1]-1), (255,0,0), 1)
            
            cv2.imwrite("stn/show_stn_2_{}.png".format(opt.stn_image.split('/')[-1][:9]), img)
        ...
        if num == 3:
            ...
            cv2.imwrite("stn/show_stn_3_{}.png".format(opt.stn_image.split('/')[-1][:9]), img)
